...
import { 
    ...
    VideoIcon, Clock4, Calendar, Copy, Check
} from 'lucide-react';
                ...
                <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
                    <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="space-y-4">
                        ...
                        <div className="relative">
                            ...
                            <input type="text" placeholder="Meeting Name" value={meetingName} onChange={(e) => setMeetingName(e.target.value)} className="w-full bg-slate-700/50 border-2 border-slate-600 rounded-lg py-3 pl-12 pr-4 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                        </div>
                        <div className="relative">
...
const MeetingPage = () => {
    ...
    // --- CHANGE: State for streaming and recording ---
    ...
    const handleCreateMeeting = async (meetingData) => {
        ...
        try {
            ...
            showToast({ title: 'Success!', message: 'Meeting created successfully!', type: 'success' });
        ...
        <div className="flex h-screen relative z-10">
            ...
            <div className="flex-1 flex flex-col h-screen">
                    ...
                    <div className="flex items-center justify-between h-20 px-4 sm:px-8">
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p className="text-slate-400 text-sm hidden sm:block">Control your live meeting settings</p>
                            </div>
                        </div>
                ...
                <main className="flex-1 p-4 sm:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8 overflow-y-auto">
                    ...
                    {/* --- CHANGE: Right Sidebar Content Added --- */}
                    <motion.div 
